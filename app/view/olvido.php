    ...
    <div class="mx-5">
        <form action="<?php print RUTA; ?>login/olvido/" method="POST">
            <div class="col-lg-6">
                ...
                <input type="email" class="form-control" name="email" id="email" placeholder="gastonandres.fuentes@gmail.com" value='<?php isset($data["datas"]["email"])? print $data["datas"]["email"]:""; ?>' required>
            </div>
            <div class="col-lg-6">
