        ...
        <div class="mx-5 my-3">
            <form method="POST" action="<?php print RUTA.'contacto/enviar'; ?>">
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Gaston" required value='<?php isset($data["datas"]["nombre"])? print $data["datas"]["nombre"]:""; ?>'>
                </div>
                <div class="form-group">
                    <label for="correo" class="form-label text-dark fw-bold my-1">E-mail: *</label>
                    <input type="emal" name="correo" id="correo" class="form-control" placeholder="gastonandres.fuentes@gmail.com" required value='<?php isset($data["datas"]["email"])? print $data["datas"]["email"]:""; ?>'>
                </div>
                <div class="form-group">
                    <label for="telefono" class="form-label text-dark fw-bold my-1">telefono: </label>
                    <input type="text" name="telefono" id="telefono" class="form-control" placeholder="+569 61592539" value='<?php isset($data["datas"]["telefono"])? print $data["datas"]["telefono"]:""; ?>'>
                </div>
                <div class="form-group">
